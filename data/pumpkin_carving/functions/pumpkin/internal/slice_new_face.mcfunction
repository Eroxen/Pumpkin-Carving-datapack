...
$execute as @e[type=item_display,tag=pumpkin_carving.model,tag=pumpkin_carving.model.root.$(face),distance=..0.1,limit=1] run function pumpkin_carving:pumpkin/internal/recursive_kill
